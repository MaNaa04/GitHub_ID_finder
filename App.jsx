  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-white">
      ...
      <div className="relative overflow-hidden bg-[#161b22] border-b border-gray-800">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?q=80&w=2000&auto=format&fit=crop')] opacity-5"></div>
            ...
            <form onSubmit={fetchGitHubUser} className="max-w-2xl mx-auto">
              <div className="relative group">
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-md hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-medium"
                  >
                    Search
                  </button>
                </div>
